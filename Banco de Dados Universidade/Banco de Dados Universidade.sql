...
CREATE TABLE CURSO_DISCIPLINA(
	ID INT IDENTITY(1,1) NOT NULL, 
	CONSTRAINT FK_CURSO FOREIGN KEY(ID)
	CONSTRAINT FK_DICIPLINA FOREIGN KEY(ID)
...
CREATE TABLE PROFESSOR(
	...
	CONSTRAINT FK_ENDERECO FOREIGN KEY(ID)
...
CREATE TABLE FUNCIONARIOS(
	...
	CONSTRAINT FK_ENDERECO FOREIGN KEY(ID)
	CONSTRAINT FK_TELEFONE FOREIGN KEY(ID)
...
CREATE TABLE ALUNO_DISCIPLINA(
	...
	CONSTRAINT FK_DISCIPLINA FOREIGN KEY(ID),
